...
export class CommodityComponent implements OnInit {
  ...
  uintPrice = new FormControl('', Validators.required);
  ...
  addAsset(form: any): Promise<any> {
    this.asset = {
      ...
      'uintPrice': this.uintPrice.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.uintPrice) {
        formObject.uintPrice = result.uintPrice;
      } else {
        formObject.uintPrice = null;
      }
